...
class Solution2{
    ...
    func getCheckRules()->[[(Int,Int)]]{
        ...
        for x in 0..<3{
            for y in 0..<3{
                rules.append(boxTranslation(box, x: x*3, y: y*3))
            }
        }
    ...
    func boxTranslation(box:[(Int,Int)],x:Int,y:Int)->[(Int,Int)]{
//        var output:[(Int,Int)] = []
//        for element in box{
//            output.append((element.0+x,element.1+y))
//        }
//        return output
